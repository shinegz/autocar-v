            ...
            for (let i = 0; i < newData[kind].length; ++i) {
                switch (kind) {
                    case "lane":
                        ...
                        // 将新的Map Element数据和与之对应的3D对象保存在this.data中
